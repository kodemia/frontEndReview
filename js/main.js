...
var dishesArray = [
  ...
  },
  {
    name: "Platillo 2",
    imgUrl:
      "https://d1nsq2txwd94q7.cloudfront.net/public/files/production/recipes/images/521/fancy/r_521_1550837766.jpg",
  ...
  },
  {
    name: "Platillo 3",
    imgUrl:
      "https://www.mexicoenmicocina.com/wp-content/uploads/2018/03/nopales-a-la-mexicana-5-500x427.jpg",
...
const loadPage = () => {
  $("#dishes-wrapper").load("carrito.html", printCard);
};

const printCard = () => {
  $("#dishes-wrapper").empty();
  selectedMenus.forEach((dish, index) => {
    $("#dishes-wrapper").append(`<div class="col mb-4">
          <div class="card">
              <div class="card-body">
                  <h5 class="card-title">${dish}</h5>
                  <div class="d-flex justify-content-between">
                      <h3>$${calculateDishPrice(dish)}.00</h3>
                  </div>
              </div>
          </div>
      </div>`);
